...
- (void)loadWebPage
{
    ...
    NSString *popupWelcome = nil;
    popupWelcome = [[appConfigRecord appConfigInstance] popupWelcome];
    if (popupWelcome != nil && [@"YES" compare:[popupWelcome uppercaseString]] == 0)
    {
        NSString *urlString = nil;
        urlString = [[appDateRecord appDateInstance] welcomePage];
