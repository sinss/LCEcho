//
//  pccuMedia1TableViewController.m
//  pccuPrject
//
...
@interface pccuMedia1TableViewController ()
...
@implementation pccuMedia1TableViewController
...
- (void)viewDidLoad
{
    ...
    if (downloadMedia == nil)
    {
        ...
        if (tabUrl1 != nil)
        {
            ...
            downloadMedia.csvLoadtype = csvLoadTypePccuMedia;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    pccuMediaRecord *record = [pccuMediaArray objectAtIndex:row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    NSUInteger row = [indexPath row];
    pccuMediaRecord *record = [pccuMediaArray objectAtIndex:row];
    pccuMediaDetailViewController *mediaDetailView = [[pccuMediaDetailViewController alloc] initWithNibName:@"pccuMediaDetailViewController" bundle:nil];
    [mediaDetailView setCurrentMediaRecord:record];
    [mediaDetailView setPccuMediaType:pccuMediaType];
...
- (NSURL*)lazyImageURLForIndexPath:(NSIndexPath*)indexPath
{
	...
	pccuMediaRecord *record = [pccuMediaArray objectAtIndex:indexPath.row];
