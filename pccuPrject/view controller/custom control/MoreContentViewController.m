...
- (void)webViewDidFinishLoad:(UIWebView *)web
{
    ...
    [infoPanel showPanelInView:webView type:infoPanelTypeInfo title:@"提示訊息" subTitle:@"下載完成" hideAfter:3];
}
- (void)webView:(UIWebView *)web didFailLoadWithError:(NSError *)error
{
    [activityView stopAnimating];
    [infoPanel showPanelInView:webView type:infoPanelTypeError title:@"提示訊息" subTitle:@"載入失敗" hideAfter:3];
}
