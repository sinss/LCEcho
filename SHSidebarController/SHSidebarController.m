...
{
    [tap release], tap = nil;
    [swipeL release], swipeL = nil;
    [swipeR release], swipeR = nil;
    [behindV release], behindV = nil;
    [mainVC release], mainVC = nil;
    [menuVC release], menuVC = nil;
    [viewsArray release], viewsArray = nil;
    [super dealloc];
}
...
-(void)changeMain:(UIViewController *)main{
    ...
    self.mainVC.view.frame = CGRectMake(0, 0, 320, height);
    ...
    */
    ...
    UIBarButtonItem *src = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"lines.png"] style:UIBarButtonItemStyleBordered target:self action:@selector(menuChange)];
    v.navigationItem.leftBarButtonItem = src;
...
-(void)open{
    ...
    if (!menuOpened){
        ...
        [self.mainVC.view showOrigamiTransitionWith:self.menuVC.view NumberOfFolds:1 Duration:.3 Direction:XYOrigamiDirectionFromLeft completion:^(BOOL finished) {
